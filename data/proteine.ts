...
const sojageschnezeltesBraten = new Zubereitungsart(
  ...
  'Das getrocknete Geschnetzelte mit kochendem Wasser übergißene und etwa 5 Minuten stehen lassen. ' +
    ...
    'Die marinierten Schnetzel für 6 Minuten von allen Seiten in einer Pfanne mit heißem Öl knusprig braten.',
);
...
export let proteinquelle: Protein[] = [
  ...
  new Protein(2, 'Sojageschnezeltes', [sojageschnezeltesBraten], 100, vegan, [
    new Gewürz('Knoblauchpulver', 2, 'TL'),
    new Gewürz('Zwiebelpulver', 1, 'TL'),
    new Gewürz('Liquidsmoke', 'ein paar Tropfen ', ''),
    new Gewürz('Kreuzkümmel', 1, 'TL'),
    new Gewürz('Sojasauce', 2, 'TL'),
    new Gewürz('Ahornsirup', 1, '1TL'),
    new Gewürz('Gemüsebrühe oder Glutamat', 1, 'TL'),
    new Gewürz('Senf', '1/2 TL', ''),
    new Gewürz('Tomatenmark', 1, 'TL'),
    new Gewürz('Wasser', 3, 'EL'),
  ]),
